...
const adminAnalytics = read('supabase/functions/lifemate-admin-api/product_version_analytics.ts');
...
requireText(adminRoutes, 'matchAccountProductVersionsPath', 'User 360 route parser wiring');
requireText(adminAnalytics, 'product-versions', 'User 360 version context Admin API');
