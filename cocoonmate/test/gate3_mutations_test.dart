...
void main() {
  ...
  test(
    'check-in online success is server-confirmed and never queued',
    () async {
      String? onlineId;
      String? onlineDate;
      var queued = false;
  ...
  test(
    'network failure queues check-in with the exact same request id',
    () async {
      String? onlineId;
      String? queuedId;
  ...
  test(
    'authorization failure is never converted into an offline queue',
    () async {
      var queued = false;
      final adapter = _adapter(
        submitCheckInOnline:
  ...
  test(
    'measurement retry preserves canonical type, values and request id',
    () async {
      String? onlineId;
      String? queuedId;
      String? queuedType;
