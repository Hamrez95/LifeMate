...
void main() {
  testWidgets('quick check-in honors platform reduce motion', (tester) async {
    ...
    expect(animatedChoices.every((widget) => widget.duration == Duration.zero),
        isTrue);
  });

  testWidgets('quick check-in energy choices reflow on a narrow large-text view',
      (tester) async {
  ...
  testWidgets('symptom loading and empty states never enable submission',
      (tester) async {
