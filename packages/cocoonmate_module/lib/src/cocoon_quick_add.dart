                ...
                builder: (context, constraints) {
                  ...
                  final tiles = [
                    ...
                    _QuickAddTile(
                      ...
                      enabled: enabled.contains(CocoonQuickAddKind.measurement),
                      onTap: () => onOpen(CocoonQuickAddKind.measurement),
                    ),
                    _QuickAddTile(
                      fa: fa,
                      kind: CocoonQuickAddKind.medication,
                      enabled: enabled.contains(CocoonQuickAddKind.medication),
                      onTap: () => onOpen(CocoonQuickAddKind.medication),
                    ),
                    _QuickAddTile(
                      fa: fa,
                      kind: CocoonQuickAddKind.appointment,
                      enabled: enabled.contains(CocoonQuickAddKind.appointment),
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                fa ? 'چی رو می‌خوای ثبت کنی؟' : 'What would you like to add?',
  ...
  Widget build(BuildContext context) {
    final (icon, title, body, color, foreground) = switch (kind) {
      ...
      CocoonQuickAddKind.mood => (
        ...
        fa ? 'حال روحی' : 'Mood',
        fa ? 'یک ثبت کوتاه، بدون تشخیص' : 'A short check-in, not a diagnosis',
        CocoonTheme.sky,
