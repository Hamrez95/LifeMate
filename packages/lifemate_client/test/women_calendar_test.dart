...
void main() {
  test('keeps period timing deterministic without claiming fertility certainty', () {
  ...
  test('variable history suppresses fertility timing while preserving cycle use', () {
    final estimate = WomenCalendarEstimate.calculateFromEpisodes(
