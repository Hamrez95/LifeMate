...
void main() {
  test('women calendar episode edit sends owner-only correction payload', () async {
    ...
    expect(
      observed.url.path,
      '/api/v1/women-calendar/episodes/episode-1',
    );
  ...
  test('women calendar episode edit can reopen an episode and clear notes', () async {
    late http.Request observed;
    final api = LifeMateApiClient(
      baseUri: Uri.parse('https://api.example.test'),
      accessToken: () => 'access-token',
