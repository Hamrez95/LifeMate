...
begin
  ...
  if found then
    ...
    elsif trim(v_scenario.currency) <> p_currency then
...
revoke all on function admin.configure_finance_scenario(
  uuid,uuid,character varying,character varying,character varying,date,date,jsonb,integer,character varying,uuid,character varying,character varying
) from public;
...
drop function admin.configure_finance_scenario(
  uuid,uuid,character varying,character varying,character,date,date,jsonb,integer,character varying,uuid,character varying,character varying
);
