...
export function recurrencePublicValue(rule: CareRecurrenceRule | null): Record<string, unknown> {
  ...
  return {
    ...
    endDate: rule.endAt == null ? null : rule.unit === "hour" ? rule.endAt : rule.endAt.slice(0, 10),
