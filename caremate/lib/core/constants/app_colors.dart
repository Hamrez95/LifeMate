...
class AppColors {
  ...
  static const Color CalPrimary =
      Color.fromARGB(255, 141, 205, 248); //  سلکت تقویم
  static const Color CalFisrtDot =
      Color.fromARGB(255, 255, 34, 53); //  دات  دارو تقویم
  static const Color CalSecondDot =
      Color.fromARGB(255, 30, 83, 255); //  دات  دارو تقویم
  static const Color CalBackForgotten =
      Color.fromARGB(255, 255, 114, 133); //  دات  دارو تقویم
