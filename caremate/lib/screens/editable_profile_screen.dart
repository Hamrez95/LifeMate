...
class CareMateEditableProfileScreen extends StatefulWidget {
  const CareMateEditableProfileScreen({super.key});

  @override
  State<CareMateEditableProfileScreen> createState() =>
      _CareMateEditableProfileScreenState();
}

class _CareMateEditableProfileScreenState
    extends State<CareMateEditableProfileScreen> {
      ...
      body: SafeArea(
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            if (_profile == null || _profile?['version'] != data['version']) {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _ProfileField(
                      key: const ValueKey('care-profile-display-name'),
                    ...
                    _ProfileField(
                      key: const ValueKey('care-profile-email'),
                      controller: _email,
                      label: 'ایمیل حساب',
                    ...
                    const SizedBox(height: 14),
                    _ProfileField(
                      key: const ValueKey('care-profile-phone'),
                      controller: _phone,
                    ...
                    SegmentedButton<String>(
                      key: const ValueKey('care-profile-locale'),
                      segments: const [
                    ...
                    const SizedBox(height: 18),
                    _ProfileField(
                      key: const ValueKey('care-profile-time-zone'),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        key: const ValueKey('care-profile-save'),
